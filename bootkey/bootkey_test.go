...
func TestExtractFromFile(t *testing.T) {
	t.Run("Test ExtractFromFile", func(t *testing.T) {
		key, err := ExtractFromFile(path)
...
func BenchmarkExtractFromFile(b *testing.B) {
	b.Run("Benchmark ExtractFromFile", func(b *testing.B) {
		for n := 0; n < b.N; n++ {
